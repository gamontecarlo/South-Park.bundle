...
-------
On the new Plex, the layout changes when you move the focus off the random episode. This version fixes it, and also gives you two random episodes for the price of one! Isn't that incredible?
